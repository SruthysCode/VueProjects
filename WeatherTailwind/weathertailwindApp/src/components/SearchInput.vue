...
const apiKey ="1dc54f517b9344c997262222240907"
...
const getWeather = async (place) => {
  console.log("id = ",place.id, place)
  const res = await fetch(
    `http://api.weatherapi.com/v1/forecast.json?key=${apiKey}&q=${place.name}&days=1&aqi=no&alerts=no`
  )
